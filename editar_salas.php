...
if(isset($_POST['edit_cat'])){
  ...
  if(empty($errors)){
        $sql = "UPDATE categories3 SET name='{$cat_name}'";
       $sql .= " WHERE id='{$categorie['id']}'";
     $result = $db->query($sql);
     if($result && $db->affected_rows() === 1) {
       $session->msg("s", "SALA ACTUALIZADA EXITOSAMENTE");
   ...
   <div class="col-md-5">
     <div class="panel panel-default">
       ...
       <div class="panel-body">
         <form method="post" action="editar_salas.php?id=<?php echo (int)$categorie['id'];?>">
