      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <div class="panel-heading clearfix">
            ...
            <span><b>Cambiar mi foto</b></span>
          </div>
        </div>
        <div class="panel-body">
          <div class="row">
            <div class="col-md-4">
                <img class="img-rounded " style="width: 100%; height: 100%" src="uploads/users/<?php echo $user['image'];?>" alt="">
            </div>
            <div class="col-md-8">
              ...
              <div class="form-group pull-right" style="margin-top: 74px;">
                <input type="hidden" name="user_id" value="<?php echo $user['id'];?>">
                 <button type="submit" name="submit" class="btn btn-warning">Cambiar</button>
              </div>
              <div class="form-group pull-left" style="margin-top: 74px;">
                  <a href="perfil.php?id=<?php echo (int)$user['id'];?>" title="Ver Perfil" class="btn btn-success">Ficha Personal</a>
              </div>
             </form>
            </div>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
          <div class="panel-heading clearfix">
            ...
            <span><b>Editar mi cuenta</b></span>
          </div>
        </div>
      <div class="panel-body">
