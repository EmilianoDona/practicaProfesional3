   ...
   if(empty($errors)){
        ...
        $result = $db->query($query);
         if($result && $db->affected_rows() === 1){
          ...
          redirect('editar_grupos.php?id='.(int)$e_group['id'], false);
        } else {
          //failed
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
          <div class="panel-heading clearfix">
            ...
            <span><b>Editar Grupo</b></span>
          </div>
        </div>
      <div class="panel-body">
          <?php echo display_msg($msg); ?>
      <form method="post" action="editar_grupos.php?id=<?php echo (int)$e_group['id'];?>" class="clearfix">
