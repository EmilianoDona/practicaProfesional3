...
<?php
  $page_title = 'Listado de Salas';
  require_once('includes/load.php');
  // Checkin What level user has permission to view this page
  page_require_level(1);
  
  $all_categories = find_all('categories3')
?>
...
<?php
 if(isset($_POST['add_cat'])){
   ...
   if(empty($errors)){
      $sql  = "INSERT INTO categories3 (name)";
      $sql .= " VALUES ('{$cat_name}')";
      if($db->query($sql)){
        $session->msg("s", "SALA AGREGADA EXITOSAMENTE");
        redirect('agregar_salas.php',false);
      } else {
      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <strong>
            ...
            <span>Agregar Salas</span>
         </strong>
        </div>
        <div class="panel-body">
          <form method="post" action="agregar_salas.php">
              ...
              <?php foreach ($all_categories as $cat):?>
                <tr>
                    ...
                    <td class="text-center">
                      <div class="btn-group">
                        <a href="editar_salas.php?id=<?php echo (int)$cat['id'];?>"  class="btn btn-xl btn-warning" data-toggle="tooltip" title="Editar">
                        ...
                        <a class="btn btn-xl btn-danger" data-toggle="tooltip" title="Eliminar" data-confirm onclick="new jBox('Notice', {content: 'Eliminado', color: 'red', attributes: {y: 'bottom'}, onCreated: function () {
                          location.href = 'eliminar_salas.php?id=<?php echo (int)$cat['id'];?>'
                        }})">
