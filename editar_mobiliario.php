...
<?php
 if(isset($_POST['product'])){
   ...
   if(empty($errors)){
       ...
       $query   = "UPDATE products3 SET";
       $query  .=" name ='{$p_name}', quantity ='{$p_qty}',";
       $query  .=" categorie_id ='{$p_cat}',media_id='{$media_id}'";
       $query  .=" WHERE id ='{$product['id']}'";
       $result = $db->query($query);
               if($result && $db->affected_rows() === 1){
                 $session->msg('s',"MOBILIARIO ACTUALIZADO EXITOSAMENTE");
                 redirect('lista_mobiliario.php', false);
               } else {
                 $session->msg('d',' Lo siento, actualización falló.');
                 redirect('editar_mobiliario.php?id='.$product['id'], false);
               }
        ...
        <div class="panel-body">
         <div class="col-md-12">
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-md-12">
                  <form method="post" action="editar_mobiliario.php?id=<?php echo (int)$product['id'] ?>">
                <ul class="list-group">
