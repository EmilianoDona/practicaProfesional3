<?php
  $page_title = 'Editar Listado Editorial';
...
<?php
  ...
  if(!$categorie){
    ...
    redirect('agregar_listado_editorial.php');
  }
?>
   ...
   <div class="col-md-5">
     <div class="panel panel-default">
       ...
       <div class="panel-body">
         <form method="post" action="editar_listado_editorial.php?id=<?php echo (int)$categorie['id'];?>">
